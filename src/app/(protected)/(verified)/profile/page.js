                    ...
                    <CardContent className="pt-8 flex flex-col items-center text-center space-y-4">
                        ...
                        <div className="flex gap-2 pt-2">
                            <div className="px-3 py-1 bg-white/5 rounded-full text-xs font-medium text-gray-300 border border-white/5 flex items-center gap-2">
                                ...
                                {user.designation || (user.role === 'admin' ? 'Administrator' : 'User')}
                            </div>
                        </div>
                    </CardContent>
                </Card>
                    ...
                    <CardContent className="space-y-6">
                        <div className="grid md:grid-cols-2 gap-6">
                            ...
                            <div className="space-y-2">
                                ...
                                <div className="h-14 px-3 py-2 rounded-md bg-[#1e293b]/50 border border-white/10 text-white flex items-center">

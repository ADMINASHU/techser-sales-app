...
export default async function VerificationPendingPage(props) {
    ...
    <div className="flex flex-col items-center justify-center py-5 px-4 min-h-[70vh]">
      <Card className="w-full max-w-lg bg-[#0A0A0B] border-white/10 shadow-2xl text-center overflow-hidden">
        ...
        <CardHeader className="pt-5 pb-6">
          <div
            className={`mx-auto w-20 h-20 ${reason ? "bg-red-500/10" : "bg-yellow-500/10"} rounded-full flex items-center justify-center mb-6 ring-4 ${reason ? "ring-red-500/5" : "ring-yellow-500/5"} ${!reason && "animate-pulse"}`}
          >
            {reason ? (
        ...
        <CardContent className="px-10 pb-10 space-y-6">
          {reason === "declined" && (
            ...
            >
              ...
              <AlertDescription className="text-red-300/80">
                Your account verification was declined by an administrator.
          ...
          {reason === "deleted" && (
            ...
            >
              ...
              <AlertDescription className="text-red-300/80">
                Your account has been removed by an administrator. Please
            ...
            <>
              <div className="p-6 rounded-2xl bg-white/5 border border-white/5 space-y-4">
                <p className="text-gray-300 text-base leading-relaxed">
                  ...
                  currently under review by the administrator to ensure security
                  and data integrity.
                </p>
                <div className="flex items-start gap-3 text-left bg-blue-500/5 p-4 rounded-xl border border-blue-500/10">
                  ...
                  <p className="text-sm text-blue-300/80 italic">
                    Access to the dashboard and entry logging is restricted
                    until your account status is updated to verified.
                  </p>
                </div>
              </div>

              <p className="text-sm text-gray-500">
                You will receive a notification once the approval process is
                complete.
              </p>

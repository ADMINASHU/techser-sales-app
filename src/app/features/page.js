...
export const metadata = {
  ...
  description:
    "Detailed overview of the features and technical specifications of the Techser Sales Application.",
};
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8 md:py-16 space-y-16">
      <Link href="/releases">
        <Button
          variant="ghost"
          className="text-gray-400 hover:text-white pl-0 mb-8"
        >
      ...
      <section className="text-center space-y-6 animate-in fade-in slide-in-from-bottom-8 duration-700">
        <Badge
          variant="outline"
          className="px-4 py-1 border-primary/30 bg-primary/5 text-primary mb-4"
        >
          Product Overview
        </Badge>
        ...
        <p className="text-lg md:text-xl text-muted-foreground/80 max-w-2xl mx-auto">
          A comprehensive look at the capabilities and technical architecture
          driving the Techser Sales Application.
        </p>
      </section>
      ...
      <section className="space-y-12">
        <div className="text-center space-y-4">
          ...
          <p className="text-muted-foreground">
            The essential tools designed to empower field sales professionals.
          </p>
        </div>
      ...
      <section className="space-y-8">
        <div className="space-y-4">
          ...
          <p className="text-muted-foreground max-w-lg">
            Built with a modern, high-performance stack ensuring scalability,
            ...
            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1" className="border-white/5">
                ...
                <AccordionContent className="text-muted-foreground pt-2">
                  Powerful text-based search across customer names and contacts,
                  combined with multi-parameter filtering by date, status, and
                  assignment.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-2" className="border-white/5">
                ...
                <AccordionContent className="text-muted-foreground pt-2">
                  Seamless data handling with dedicated Excel and CSV export
                  capabilities for robust reporting, backups, and external
                  analysis.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="item-4" className="border-white/5">
                ...
                <AccordionContent className="text-muted-foreground pt-2">
                  Uses Haversine logic for both stamp-in proximity validation
                  and 50m radius duplicate customer detection.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-5" className="border-white/5">
                ...
                <AccordionContent className="text-muted-foreground pt-2">
                  Optimized mobile experience using virtualization
                  (react-virtuoso) for infinite scrolling on massive datasets
                  without lag.
                </AccordionContent>
              </AccordionItem>
              <AccordionItem value="item-6" className="border-white/5">
                ...
                <AccordionContent className="text-muted-foreground pt-2">
                  Active/Inactive status toggles to maintain a clean workspace
                  and filter out dormant customers from daily views.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
          </div>

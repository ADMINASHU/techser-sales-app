      ...
      <div className="max-w-3xl mx-auto">
        <div className="mb-10">
          <div className="flex items-center justify-between mb-4">
            ...
            {isAdmin && (
              <Link href="/features">
                <Button className="glass-btn-primary rounded-full px-6 h-9 text-sm">
                  View All Features
                </Button>
              </Link>
            )}
        ...
        <div className="space-y-8">
          {releaseData.length === 0 && (
            <div className="p-8 text-center text-gray-500 glass-panel rounded-xl">
                ...
                <div className="p-6 border-b border-white/5 bg-white/2">
                  <div className="flex items-center justify-between mb-1">
                    <div className="flex items-center gap-3">
                      ...
                      {idx === 0 && (
                        <span className="bg-blue-500/20 text-blue-400 text-[10px] font-bold px-2 py-0.5 rounded-full border border-blue-500/20 uppercase tracking-wide">
                          Latest
                        </span>
                      )}
                    </div>
                        ...
                        {improvements.length > 0 ? (
                          <ul className="space-y-3">
                            {improvements.map((item, i) => (
                              <li
                                key={i}
                                className="text-gray-400 text-sm leading-relaxed pl-4 relative before:content-[''] before:absolute before:left-0 before:top-2 before:w-1.5 before:h-1.5 before:bg-blue-400 before:rounded-full"
                              >
                                {item}
                              </li>
                            ))}
                        ...
                        {fixes.length > 0 ? (
                          <ul className="space-y-3">
                            {fixes.map((item, i) => (
                              <li
                                key={i}
                                className="text-gray-400 text-sm leading-relaxed pl-4 relative before:content-[''] before:absolute before:left-0 before:top-2 before:w-1.5 before:h-1.5 before:bg-rose-400 before:rounded-full"
                              >
                                {item}
                              </li>
                            ))}
                        ...
                        {patches.length > 0 ? (
                          <ul className="space-y-3">
                            {patches.map((item, i) => (
                              <li
                                key={i}
                                className="text-gray-400 text-sm leading-relaxed pl-4 relative before:content-[''] before:absolute before:left-0 before:top-2 before:w-1.5 before:h-1.5 before:bg-amber-500 before:rounded-full"
                              >
                                {item}
                              </li>
                            ))}

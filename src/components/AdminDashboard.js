...
export default function AdminDashboard({
  ...
  ); // locations: [{name, branches:[]}]
  const [filtersLoading, setFiltersLoading] = useState(!initialFilters);

  // Default to server provided date or fallback to current
  // Use proper Date object creation to ensure string serialization didn't break it if passed from server actions (though here it's passed from SC prop)
  const currentDate = useMemo(
    () => (serverDate ? new Date(serverDate) : new Date()),
    [serverDate],
  );

  // Initialize state with server-consistent values
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-4 grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 mb-8">
        ...
        <Card className="glass-card shadow-lg relative overflow-hidden group hover:border-rose-500/30 transition-all">
          ...
          <CardContent className="p-4 pt-0">
            <div className="text-2xl font-bold text-rose-500 relative z-10">
              {fetchLoading ? "--" : displayCount}
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="glass-card border-violet-500/20 shadow-lg relative overflow-hidden group hover:border-violet-500/40 transition-all">
          ...
          <CardHeader className="pb-2 p-4">
            <CardTitle className="text-xs font-medium text-violet-300 uppercase tracking-wider relative z-10">
              Admins
            </CardTitle>
          </CardHeader>
          <CardContent className="p-4 pt-0">
        ...
        <Card className="glass-card border-blue-500/20 shadow-lg relative overflow-hidden group hover:border-blue-500/40 transition-all">
          ...
          <CardHeader className="pb-2 p-4">
            <CardTitle className="text-xs font-medium text-blue-300 uppercase tracking-wider relative z-10">
              Users
            </CardTitle>
          </CardHeader>
          <CardContent className="p-4 pt-0">
        ...
        <Card className="glass-card border-amber-500/20 shadow-lg relative overflow-hidden group hover:border-amber-500/40 transition-all">
          ...
          <CardHeader className="pb-2 p-4">
            <CardTitle className="text-xs font-medium text-amber-300 uppercase tracking-wider relative z-10">
              Locations
            </CardTitle>
          </CardHeader>
          <CardContent className="p-4 pt-0">

...
export default function AdminEntryDetailsModal({
  entry,
  isOpen,
  onClose,
  session,
          ...
          <div className="lg:col-span-1 bg-[#0b0f19] p-4 lg:p-5 h-auto lg:h-full lg:overflow-y-auto flex flex-col relative hide-scrollbar">
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-1">
                <Label className="text-gray-500 font-medium text-[10px] tracking-[0.2em]">
                  VISITED BY
                </Label>
              ...
              <div className="space-y-1">
                <div className="flex justify-between items-center text-xs">
                  ...
                  <span className="text-white font-medium text-[11px]">
                    {entry.stampIn?.time
                      ? formatInIST(entry.stampIn.time, "PPP, p")
                      : "-"}
                  </span>
                </div>
                <div className="flex justify-between items-center text-xs">
                  ...
                  <span className="text-white font-medium text-[11px]">
                    {entry.stampOut?.time
                      ? formatInIST(entry.stampOut.time, "PPP, p")
                      : "-"}
                  </span>
                </div>
              </div>
              ...
              {entry.comment && (
                <div className="space-y-1.5 pt-2 border-t border-white/5">
                  ...
                  <div className="flex items-start gap-2 p-2 rounded-lg bg-yellow-500/5">
                    <MessageSquare className="w-3.5 h-3.5 mt-0.5 shrink-0 text-yellow-400" />

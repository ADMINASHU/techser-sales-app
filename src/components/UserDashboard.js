    ...
    return (
        <div className="space-y-6">
            <div className="grid gap-6 md:grid-cols-3">
                ...
                <div className="glass-card p-4 rounded-xl shadow-lg relative overflow-hidden group">
                    ...
                    <div className="pb-2">
                        <div className="text-sm font-medium text-gray-400 uppercase tracking-wider">Total Entries</div>
                    </div>
                    <div>
                ...
                <div className="glass-card p-4 rounded-xl shadow-lg relative overflow-hidden group">
                    ...
                    <div className="pb-2">
                        <div className="text-sm font-medium text-gray-400 uppercase tracking-wider">Completed Visits</div>
                    </div>
                    <div>
                ...
                <div className="glass-card p-4 rounded-xl shadow-lg relative overflow-hidden group">
                    ...
                    <div className="pb-2">
                        <div className="text-sm font-medium text-gray-400 uppercase tracking-wider">Pending / Others</div>
                    </div>
                    <div>
